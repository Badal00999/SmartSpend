      ...
      <div className="h-64 w-full" aria-hidden="true">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 8, right: 8, left: -8, bottom: 0 }} barCategoryGap="28%">
            ...
            <XAxis dataKey="month" tickFormatter={(m) => formatMonth(m).split(' ')[0]} tick={{ fill: axisColor, fontSize: 12 }} axisLine={false} tickLine={false} />
            <YAxis tickFormatter={(v) => formatCompact(v)} tick={{ fill: axisColor, fontSize: 11 }} axisLine={false} tickLine={false} width={64} />
