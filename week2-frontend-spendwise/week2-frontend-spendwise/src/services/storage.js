 ...
 * directly. Since Week 3 the app also talks to the SpendWise REST API
 * (see ./api.js + ./transactionsApi.js); this module remains the offline /
 * guest-mode store and the source for "import my browser data".
 */
...
/** Read whatever is stored WITHOUT seeding demo data (used for account import). */
export function peekLocalTransactions() {
  if (typeof window === 'undefined') return []
