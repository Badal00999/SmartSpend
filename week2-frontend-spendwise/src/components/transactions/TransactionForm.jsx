  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-4">
      ...
      <FormField uid={uid} error={fieldError('title')} name="title" label="Title">
        <input type="text" placeholder="e.g. Grocery shopping" maxLength={80} autoComplete="off" {...inputProps('title')} />
      </FormField>
      ...
      <FormField uid={uid} error={fieldError('notes')} name="notes" label="Notes (optional)" hint={`${values.notes.length}/200`}>
